...
class ExamListView extends StatelessWidget {
  const ExamListView({super.key, required this.color, required this.subjectStudent, required this.teacherName, required this.totalDegree, required this.degreeStudent});
  final Color color;
